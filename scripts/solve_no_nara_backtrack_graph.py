...
building_doors = {
    'security_room': {"lat": 6.974779, "lon": 79.871773},
...
# Dense outdoor walkway nodes strictly on Ocean University campus pedestrian paths
walkway_nodes = [
    ...
    {"id": "w_south_gate_corner", "name": "Main Gate Security Office Corner", "lat": 6.97470, "lon": 79.871773},
...
connections = [
    # Security Room Direct Connection
    ...
    ("w_south_02", "w_east_01"), # DIRECT CROSS-COURTYARD CONNECTION!
...
print(f"\nFinal Graph: {len(all_nodes)} nodes, {len(valid_edges)} 100% strict internal edges. Rejected {rejected} clipping edges.")
