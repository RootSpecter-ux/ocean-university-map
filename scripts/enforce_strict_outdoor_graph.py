...
building_entrances = {
    ...
    'training_and_account_division': {"lat": 6.97538, "lon": 79.87168},
...
# 2. Outdoor Pedestrian Walkway Corridors
walkway_waypoints = [
    # WEST OUTDOOR HIGHWAY (Lon = 79.87154 -> 100% Outdoor)
    ...
    # SOUTH GATE EAST CONNECTOR (Lat = 6.97478)
    {"id": "w_south_east_connector", "name": "South Outdoor Connector Path", "lat": 6.97478, "lon": 79.87203},

    # EAST OUTDOOR HIGHWAY (Lon = 79.87205 / 79.87208 -> Completely clear of east building blocks)
    {"id": "w_east_corridor_south", "name": "East Outdoor Walkway (Lab & Classrooms)", "lat": 6.97484, "lon": 79.87203},
    {"id": "w_east_corridor_mid", "name": "East Outdoor Walkway (IT Lab & Transport)", "lat": 6.97541, "lon": 79.87205},
    {"id": "w_east_corridor_north", "name": "East Outdoor Walkway (Welding Workshop)", "lat": 6.97571, "lon": 79.87205},

    # FAR EAST CLASSROOMS HIGHWAY (Lon = 79.87260 -> Completely east of all classroom blocks)
    {"id": "w_far_east_south", "name": "Far East Walkway (Volley Court)", "lat": 6.97514, "lon": 79.87260},
    {"id": "w_far_east_mid", "name": "Far East Walkway (MTL Hall 01)", "lat": 6.97528, "lon": 79.87260}
]
...
# 3. Candidate Edges - TESTED & ENFORCED
candidate_connections = [
    ...
    ("w_west_road_training", "auditorium"),
    ...
    # Gate -> South East Connector -> East Outdoor Highway
    ("security_room", "w_south_east_connector"),
    ("w_south_east_connector", "lab"),
    ("w_south_east_connector", "class_room_08"),
    ("w_south_east_connector", "w_east_corridor_south"),

    # East Outdoor Highway -> Lecturers, MTL Hall 03, Classrooms 07, Courts
    ...
    # East Outdoor Highway Mid -> IT Lab, Transport, Washroom, Classrooms 02/03/04, Drawing Room
    ...
    # Far East Highway -> Classrooms & MTL Hall 01 East Access
    ("w_far_east_south", "w_far_east_mid"),
    ("w_far_east_mid", "mtl_hall_01"),
    ("w_far_east_mid", "class_room_02"),

    # East Outdoor Highway North -> Workshop & Welding Workshop
...
for u, v in candidate_connections:
    ...
    if intersects:
        print(f"REJECTED BUILDING-CLIPPING EDGE: ({u} <-> {v})")
        rejected += 1
        continue
