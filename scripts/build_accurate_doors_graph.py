...
# 1. Door Access Endpoints (Strictly Outside Doors on Open Perimeter)
building_entrances = {
    'security_room': {"lat": 6.97475, "lon": 79.87170},
    'sport_room': {"lat": 6.97494, "lon": 79.87168},
    'union_room': {"lat": 6.97490, "lon": 79.87168},
    'mtl_hall_04': {"lat": 6.97488, "lon": 79.87180},
    'mtl_hall_03': {"lat": 6.97496, "lon": 79.87213},
    'lecturers_washroom': {"lat": 6.97497, "lon": 79.87218},
    'class_room_07': {"lat": 6.97498, "lon": 79.87222},
    'volly_ball_court': {"lat": 6.97509, "lon": 79.87245},
    'badminton_court': {"lat": 6.97521, "lon": 79.87203},
    'lectueres_room': {"lat": 6.97489, "lon": 79.87185},
    'training_and_account_division': {"lat": 6.97528, "lon": 79.87168},
    'auditorium': {"lat": 6.97542, "lon": 79.87177},
    'mtl_hall_02': {"lat": 6.97535, "lon": 79.87203},
    'storage_room': {"lat": 6.97533, "lon": 79.87190},
    ...
    'students_wash_room': {"lat": 6.97527, "lon": 79.87205},
    'transport_division': {"lat": 6.97529, "lon": 79.87205},
    'it_lab': {"lat": 6.97535, "lon": 79.87205},
    'chart_room': {"lat": 6.97543, "lon": 79.87205},
    ...
    'class_room_08': {"lat": 6.97482, "lon": 79.87228},
...
# 2. Open Pedestrian Outdoor Highways
walkway_waypoints = [
    ...
    # SOUTH OUTDOOR ALLEY (Lat = 6.97470, South of Security Room, Lab, Classroom 08)
    {"id": "w_south_gate_corner", "name": "Main Gate South Alley Entry", "lat": 6.97470, "lon": 79.87170},
    {"id": "w_south_01", "name": "South Outdoor Alley (Lab Entrance)", "lat": 6.97470, "lon": 79.87204},
    {"id": "w_south_02", "name": "South Outdoor Alley (MTL 03 / Classroom 07)", "lat": 6.97470, "lon": 79.87222},
    {"id": "w_south_03", "name": "South Outdoor Alley (Classroom 08)", "lat": 6.97470, "lon": 79.87228},
    {"id": "w_south_04", "name": "South-East Highway Junction", "lat": 6.97470, "lon": 79.87258},

    # EAST OUTDOOR HIGHWAY (Lon = 79.87258, Open space East of all eastern buildings)
...
connections = [
    ...
    ("w_south_02", "mtl_hall_03"),
    ("w_south_02", "lecturers_washroom"),
    ("w_south_02", "class_room_07"),
    ("w_south_02", "w_south_03"),

    ("w_south_03", "class_room_08"),
    ("w_south_03", "w_south_04"),

    # East Outdoor Highway Spine
    ("w_south_04", "w_east_01"),
