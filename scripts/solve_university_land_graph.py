...
# 100% INTERNAL UNIVERSITY LAND PREMISES DOORS & WALKWAYS
building_doors = {
    'security_room': {"lat": 6.97472, "lon": 79.87170},
    ...
    'auditorium': {"lat": 6.97543, "lon": 79.87174},
    ...
    'workshop': {"lat": 6.97555, "lon": 79.87165},
    'welding_workshop': {"lat": 6.97572, "lon": 79.87208},
    'canteen': {"lat": 6.97565, "lon": 79.87155},
    'gym': {"lat": 6.97584, "lon": 79.87155},
    'boys_hostals': {"lat": 6.97593, "lon": 79.87155},
    'regional_center_mattakkuliya': {"lat": 6.97612, "lon": 79.87155},
...
# 100% INTERNAL OCEAN UNIVERSITY LAND WALKWAYS
walkway_nodes = [
    # INTERNAL WEST CAMPUS HIGHWAY (Strictly Inside Ocean University Land!)
    {"id": "w_west_01", "name": "Main Gate Internal West Walkway", "lat": 6.97470, "lon": 79.87165},
    ...
    # SOUTH ALLEY (Lat = 6.97470 - Inside Campus Gate)
    {"id": "w_south_gate_corner", "name": "Main Gate Internal Entry", "lat": 6.97470, "lon": 79.87170},
    ...
    # CENTRAL INTERNAL ALLEY (Lon = 79.87218)
    ...
    # EAST INTERNAL HIGHWAY (Lon = 79.87258)
...
# Candidate Connections strictly inside Ocean University land
connections = [
    # Internal West Campus Walkway Spine
...
print(f"\nFinal Internal University Land Graph: {len(all_nodes)} nodes, {len(valid_edges)} 100% strict internal edges. Rejected {rejected} clipping edges.")
