...
def segment_intersects_polygon_strict(p1, p2, poly_coords):
    ...
    for i in range(n - 1):
        C = poly_coords[i][:2]
        D = poly_coords[i+1][:2]
        # Ignore exact identical endpoints
...
# 1. Door Access Nodes (Placed strictly outside doors on perimeter)
building_entrances = {
...
# 2. Outdoor Pedestrian Corridors Network (Strictly Outdoors)
walkway_waypoints = [
    ...
    # SOUTH OUTDOOR CONNECTOR ROAD (Lat = 6.97478)
    {"id": "w_south_east_connector", "name": "South Outdoor Connector Path", "lat": 6.97478, "lon": 79.87203},

    # EAST OUTDOOR HIGHWAYS (Lon = 79.87203 & Lon = 79.87205)
...
# 3. Candidate Edges - STRICTLY ZERO WALL INTERSECTION PERMITTED
connections = [
    ...
    # East Outdoor Highway -> Lecturers, Classrooms, MTL Halls, Courts
    ...
    ("w_east_corridor_mid", "auditorium"),
    ...
    # East Outdoor Highway North -> Welding Workshop
